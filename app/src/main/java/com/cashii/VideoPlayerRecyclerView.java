...
//        });
//
//       // Toast.makeText(context, ""+videoPlayer.getCurrentTimeline(), Toast.LENGTH_SHORT).show();
...
//           // Toast.makeText(context, String.valueOf(endPosition), Toast.LENGTH_SHORT).show();
